...
def test_login_with_valid_credentials_reaches_dashboard(driver):
    ...
    login_page.complete_registration(password=password, first_name='POM', last_name='Tester', address='123 Automation Street', country='United States', state='California', city='San Francisco', zipcode='94105', mobile='5551234567')
